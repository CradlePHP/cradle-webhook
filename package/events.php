...
/**
 * $ cradle package install cradlephp/cradle-webhook
 * $ cradle package install cradlephp/cradle-webhook 1.0.0
 * $ cradle cradlephp/cradle-webhook install
 * $ cradle cradlephp/cradle-webhook install 1.0.0
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-install', function ($request, $response) {
    //custom name of this package
    $name = 'cradlephp/cradle-webhook';
    ...
    // install package
    $version = $this->package('cradlephp/cradle-webhook')->install('0.0.0');
...
/**
 * $ cradle package update cradlephp/cradle-webhook
 * $ cradle package update cradlephp/cradle-webhook 1.0.0
 * $ cradle cradlephp/cradle-webhook update
 * $ cradle cradlephp/cradle-webhook update 1.0.0
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-update', function ($request, $response) {
    //custom name of this package
    $name = 'cradlephp/cradle-webhook';
    ...
    // update package
    $version = $this->package('cradlephp/cradle-webhook')->install($current);
...
/**
 * $ cradle package remove cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook remove
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-remove', function ($request, $response) {
    //custom name of this package
    $name = 'cradlephp/cradle-webhook';
...
/**
 * $ cradle elastic flush cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook elastic-flush
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-elastic-flush', function ($request, $response) {
    $processed = $errors = [];
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
...
/**
 * $ cradle elastic map cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook elastic-map
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-elastic-map', function ($request, $response) {
    $processed = $errors = [];
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
...
/**
 * $ cradle elastic populate cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook elastic-populate
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-elastic-populate', function ($request, $response) {
    $processed = $errors = [];
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
    ...
    // set response
    $response->setResults('schema', 'webhook');
});

/**
 * $ cradle redis flush cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook redis-flush
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-redis-flush', function ($request, $response) {
    // initialize schema
...
/**
 * $ cradle redis populate cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook redis-populate
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-redis-populate', function ($request, $response) {
    // initialize schema
    $schema = Schema::i('webhook');
    // get sql service
    ...
    if (!isset($data['total']) && $data['total'] < 1) {
        // do not proceed
        return $response->setResults('schema', 'webhook');
    }
...
/**
 * $ cradle sql build cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook sql-build
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-sql-build', function ($request, $response) {
...
/**
 * $ cradle sql flush cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook sql-flush
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-sql-flush', function ($request, $response) {
    //load up the database
    $pdo = $this->package('global')->service('sql-main');
    $database = SqlFactory::load($pdo);
...
/**
 * $ cradle sql populate cradlephp/cradle-webhook
 * $ cradle cradlephp/cradle-webhook sql-populate
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-webhook-sql-populate', function ($request, $response) {
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
        if(substr($file, -4) !== '.php') {
